...
class XAGLParserVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by XAGLParser#ExprInput.
    ...
    # Visit a parse tree produced by XAGLParser#ExprAnd.
    def visitExprAnd(self, ctx:XAGLParser.ExprAndContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by XAGLParser#ExprOr.
    ...
    # Visit a parse tree produced by XAGLParser#ElseIfStat.
    def visitElseIfStat(self, ctx:XAGLParser.ElseIfStatContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by XAGLParser#ElseStat.
