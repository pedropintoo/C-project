...
class XAGLParserListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by XAGLParser#ExprInput.
    def enterExprInput(self, ctx:XAGLParser.ExprInputContext):
        pass

    # Exit a parse tree produced by XAGLParser#ExprInput.
    def exitExprInput(self, ctx:XAGLParser.ExprInputContext):
        pass
    ...
    # Enter a parse tree produced by XAGLParser#ExprAnd.
    def enterExprAnd(self, ctx:XAGLParser.ExprAndContext):
        pass

    # Exit a parse tree produced by XAGLParser#ExprAnd.
    def exitExprAnd(self, ctx:XAGLParser.ExprAndContext):
        pass


    # Enter a parse tree produced by XAGLParser#ExprOr.
    def enterExprOr(self, ctx:XAGLParser.ExprOrContext):
        pass

    # Exit a parse tree produced by XAGLParser#ExprOr.
    def exitExprOr(self, ctx:XAGLParser.ExprOrContext):
        pass
    ...
    # Enter a parse tree produced by XAGLParser#ElseIfStat.
    def enterElseIfStat(self, ctx:XAGLParser.ElseIfStatContext):
        pass

    # Exit a parse tree produced by XAGLParser#ElseIfStat.
    def exitElseIfStat(self, ctx:XAGLParser.ElseIfStatContext):
        pass


    # Enter a parse tree produced by XAGLParser#ElseStat.
    def enterElseStat(self, ctx:XAGLParser.ElseStatContext):
        pass

    # Exit a parse tree produced by XAGLParser#ElseStat.
    def exitElseStat(self, ctx:XAGLParser.ElseStatContext):
        pass
