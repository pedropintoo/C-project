...
public interface AGLParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitExprAndOr(AGLParser.ExprAndOrContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ExprDeepCopy}
	 * labeled alternative in {@link AGLParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExprDeepCopy(AGLParser.ExprDeepCopyContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code CommandRotate}
	 * labeled alternative in {@link AGLParser#command}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCommandRotate(AGLParser.CommandRotateContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code ModelStatInstantiation}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitModelStatInstantiation(AGLParser.ModelStatInstantiationContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ModelStatBlockStatement}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitModelStatBlockStatement(AGLParser.ModelStatBlockStatementContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ModelStatLongAssignment}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitModelStatLongAssignment(AGLParser.ModelStatLongAssignmentContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ModelStatAction}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitModelStatAction(AGLParser.ModelStatActionContext ctx);
	/**
