...
public class AGLParser extends Parser {
	...
	public static final int
		...
		BY=62, TO=63, ACTION=64, ON=65, PLUS=66, MINUS=67, MUL=68, DIV=69, GT=70, 
		LT=71, GTE=72, LTE=73, EQ=74, NEQ=75, AND=76, OR=77, NOT=78, ID=79, NAME=80, 
		BOOLEAN=81, INT=82, FLOAT=83, STRING=84, LINE_COMMENT=85, COMMENT=86, 
		WS=87, ERROR=88;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ON", "PLUS", "MINUS", "MUL", "DIV", "GT", "LT", "GTE", "LTE", "EQ", 
			"NEQ", "AND", "OR", "NOT", "ID", "NAME", "BOOLEAN", "INT", "FLOAT", "STRING", 
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 4099L) != 0)) ) {
	...
	public final TypeIDContext typeID() throws RecognitionException {
		...
		try {
			...
			setState(331);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & 257698021376L) != 0) || _la==ID) ) {
