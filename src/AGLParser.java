...
public class AGLParser extends Parser {
	...
	public static final int
		...
		BY=62, TO=63, ACTION=64, ON=65, PLUS=66, MINUS=67, MUL=68, DIV=69, RELATIONAL_OPERATOR=70, 
		AND=71, OR=72, NOT=73, ID=74, NAME=75, BOOLEAN=76, INT=77, FLOAT=78, STRING=79, 
		LINE_COMMENT=80, COMMENT=81, WS=82, ERROR=83;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'do'", "'after'", "'ms'", "'s'", "'move'", "'by'", "'to'", "'action'", 
			"'on'", "'+'", "'-'", "'*'", "'/'", null, "'and'", "'or'", "'not'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IF", "ELSE", "IN", "DO", "AFTER", "MS", "S", "MOVE", "BY", "TO", "ACTION", 
			"ON", "PLUS", "MINUS", "MUL", "DIV", "RELATIONAL_OPERATOR", "AND", "OR", 
			"NOT", "ID", "NAME", "BOOLEAN", "INT", "FLOAT", "STRING", "LINE_COMMENT", 
			"COMMENT", "WS", "ERROR"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2332309886181818376L) != 0) || _la==ID) {
				{
				{
				setState(52);
				stat();
	...
	private ExpressionContext expression(int _p) throws RecognitionException {
		...
		try {
			...
			case 1:
				...
				_la = _input.LA(1);
				if ( !(((((_la - 66)) & ~0x3f) == 0 && ((1L << (_la - 66)) & 131L) != 0)) ) {
				...
				setState(147);
				((ExprUnaryContext)_localctx).e = expression(15);
				}
				break;
			case 2:
				{
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						setState(192);
						((ExprAddSubMultDivAndOrContext)_localctx).e2 = expression(14);
						}
						break;
					case 2:
						{
					...
					case 3:
						...
						setState(198);
						((ExprRelationalContext)_localctx).e2 = expression(9);
						}
						break;
					}
					} 
	...
	public final ModelInstantiationContext modelInstantiation() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 1154047404529418239L) != 0) );
			setState(284);
			match(RBRACE);
			}
		}
