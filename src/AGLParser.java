...
public class AGLParser extends Parser {
	...
	public static final int
		...
		MS=31, S=32, MOVE=33, BY=34, PLUS=35, MINUS=36, MUL=37, DIV=38, ID=39, 
		INT=40, FLOAT=41, NUMBER_RANGE=42, STRING=43, LINE_COMMENT=44, COMMENT=45, 
		WS=46, ERROR=47;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'click'", "'wait'", "'for'", "'in'", "'do'", "'after'", "'ms'", "'s'", 
			"'move'", "'by'", "'+'", "'-'", "'*'", "'/'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"S", "MOVE", "BY", "PLUS", "MINUS", "MUL", "DIV", "ID", "INT", "FLOAT", 
			"NUMBER_RANGE", "STRING", "LINE_COMMENT", "COMMENT", "WS", "ERROR"
		};
	}
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 558495178752L) != 0)) {
				{
				{
				setState(30);
				stat();
