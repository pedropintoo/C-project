...
public class AGLParser extends Parser {
	...
	public static final int
		...
		BY=62, TO=63, ACTION=64, ON=65, PLUS=66, MINUS=67, MUL=68, DIV=69, LT=70, 
		GT=71, RELATIONAL_OPERATOR=72, AND=73, OR=74, NOT=75, ID=76, NAME=77, 
		BOOLEAN=78, INT=79, FLOAT=80, STRING=81, LINE_COMMENT=82, COMMENT=83, 
		WS=84, ERROR=85;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"ON", "PLUS", "MINUS", "MUL", "DIV", "LT", "GT", "RELATIONAL_OPERATOR", 
			"AND", "OR", "NOT", "ID", "NAME", "BOOLEAN", "INT", "FLOAT", "STRING", 
	...
	public final ModelInstantiationContext modelInstantiation() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 4612811918349959167L) != 0) );
			setState(305);
			match(RBRACE);
			}
		}
