...
public class AGLParser extends Parser {
	...
	public static final int
		...
		WAIT=45, INPUT=46, LOAD=47, PLAY=48, FOR=49, WHILE=50, REPEAT=51, UNTIL=52, 
		IF=53, ELSE=54, IN=55, DO=56, AFTER=57, MS=58, S=59, MOVE=60, BY=61, TO=62, 
		ACTION=63, ON=64, PLUS=65, MINUS=66, MUL=67, DIV=68, RELATIONAL_OPERATOR=69, 
		AND=70, OR=71, NOT=72, ID=73, NAME=74, BOOLEAN=75, INT=76, FLOAT=77, STRING=78, 
		LINE_COMMENT=79, COMMENT=80, WS=81, ERROR=82;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'mouse'", "'click'", "'wait'", "'input'", "'load'", "'play'", "'for'", 
			"'while'", "'repeat'", "'until'", "'if'", "'else'", "'in'", "'do'", "'after'", 
			"'ms'", "'s'", "'move'", "'by'", "'to'", "'action'", "'on'", "'+'", "'-'", 
			"'*'", "'/'", null, "'and'", "'or'", "'not'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"INPUT", "LOAD", "PLAY", "FOR", "WHILE", "REPEAT", "UNTIL", "IF", "ELSE", 
			"IN", "DO", "AFTER", "MS", "S", "MOVE", "BY", "TO", "ACTION", "ON", "PLUS", 
	...
	public final ProgramContext program() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1166159057669570568L) != 0) || _la==ID) {
				{
				{
				setState(52);
				stat();
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 3:
						...
						setState(193);
						((ExprRelationalContext)_localctx).e2 = expression(8);
						}
						break;
					}
					} 
	...
	public final ModelInstantiationContext modelInstantiation() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( ((((_la - 14)) & ~0x3f) == 0 && ((1L << (_la - 14)) & 577023702272573439L) != 0) );
			setState(279);
			match(RBRACE);
			}
		}
	...
	public final TypeIDContext typeID() throws RecognitionException {
		...
		try {
			...
			case ARRAY:
				...
				setState(339);
				match(ARRAY);
				((TypeIDContext)_localctx).res =  new ObjectType("Array");
				}
				break;
			case ID:
				...
				((TypeIDContext)_localctx).res =  new ObjectType((((TypeIDContext)_localctx).ID!=null?((TypeIDContext)_localctx).ID.getText():null));
				}
				break;
			default:
				throw new NoViableAltException(this);
