...
public interface AGLParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterExprAndOr(AGLParser.ExprAndOrContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprAndOr}
	 * labeled alternative in {@link AGLParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitExprAndOr(AGLParser.ExprAndOrContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code ExprDeepCopy}
	 * labeled alternative in {@link AGLParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterExprDeepCopy(AGLParser.ExprDeepCopyContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ExprDeepCopy}
	 * labeled alternative in {@link AGLParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitExprDeepCopy(AGLParser.ExprDeepCopyContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code CommandRotate}
	 * labeled alternative in {@link AGLParser#command}.
	 * @param ctx the parse tree
	 */
	void enterCommandRotate(AGLParser.CommandRotateContext ctx);
	/**
	 * Exit a parse tree produced by the {@code CommandRotate}
	 * labeled alternative in {@link AGLParser#command}.
	 * @param ctx the parse tree
	 */
	void exitCommandRotate(AGLParser.CommandRotateContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code ModelStatInstantiation}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void enterModelStatInstantiation(AGLParser.ModelStatInstantiationContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ModelStatInstantiation}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void exitModelStatInstantiation(AGLParser.ModelStatInstantiationContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ModelStatBlockStatement}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void enterModelStatBlockStatement(AGLParser.ModelStatBlockStatementContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ModelStatBlockStatement}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void exitModelStatBlockStatement(AGLParser.ModelStatBlockStatementContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ModelStatLongAssignment}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void enterModelStatLongAssignment(AGLParser.ModelStatLongAssignmentContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ModelStatLongAssignment}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void exitModelStatLongAssignment(AGLParser.ModelStatLongAssignmentContext ctx);
	/**
	 * Enter a parse tree produced by the {@code ModelStatAction}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void enterModelStatAction(AGLParser.ModelStatActionContext ctx);
	/**
	 * Exit a parse tree produced by the {@code ModelStatAction}
	 * labeled alternative in {@link AGLParser#modelStat}.
	 * @param ctx the parse tree
	 */
	void exitModelStatAction(AGLParser.ModelStatActionContext ctx);
	/**
