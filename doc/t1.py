...
if __name__ == "__main__":
    ...
    print(v197)
    if action is not None:
        v198 = action.view.waitClick()
    else:
        v198 = last_view.waitClick()
    ...
    if action is not None:
        action.view2.move_absolute(v201)
    else:
        view2.move_absolute(v201)
    last_refresh = time.time()
    view.update()
    ...
    temp = get_nested_attribute(action, 'pacman2.origin[v204]')
    if temp is None:
        temp = pacman2.origin[v204]
    ...
    while True:
        ...
        if action is not None:
            action.pacman2.move_relative(v212)
        else:
            pacman2.move_relative(v212)
        ...
        if action is not None:
            action.view2.move_relative(v213)
        else:
            view2.move_relative(v213)
    ...
    temp = get_nested_attribute(action, 'pacman2.origin[v230]')
    if temp is None:
        temp = pacman2.origin[v230]
    ...
    while True:
        ...
        if action is not None:
            action.pacman2.move_relative(v243)
        else:
            pacman2.move_relative(v243)
        ...
        if action is not None:
            action.pacman.move_relative(v244)
        else:
            pacman.move_relative(v244)
        ...
        if action is not None:
            action.view2.move_relative(v245)
        else:
            view2.move_relative(v245)
