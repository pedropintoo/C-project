...
if __name__ == "__main__":
    ...
    if model is not None:
        ...
        v80 = Pacman(root = root, view = last_view)
    ...
    for i in range(v86, v87, 1):
        ...
        v95 = (v96 , v97); v95 = tuple(v95) if isinstance(v95, np.ndarray) else v95
        if action is not None:
            action.pacman.move_relative(v95)
        else:
            pacman.move_relative(v95)
        ...
        v98 = (v99 , v100); v98 = tuple(v98) if isinstance(v98, np.ndarray) else v98
        if action is not None:
            action.view.move_relative(v98)
        else:
    ...
    print(v101)
    if action is not None:
        v102 = action.view.waitClick()
    else:
        v102 = last_view.waitClick()
