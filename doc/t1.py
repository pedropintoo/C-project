...
if __name__ == "__main__":
    ...
    temp = get_nested_attribute(action, '601', locals())
    if temp is None:
        temp = 601
    ...
    temp = get_nested_attribute(action, '"All"', locals())
    if temp is None:
        temp = "All"
    ...
    if temp is None:
        temp = v0
    if action is not None and hasattr(action, "view".split('[')[0].split('.')[0]):
        action.view = temp
    else:
        view = temp 
    if model is not None: 
    ...
    temp = get_nested_attribute(action, '"Line"', locals())
    if temp is None:
        temp = "Line"
    ...
    temp = get_nested_attribute(action, '"Rectangle"', locals())
    if temp is None:
        temp = "Rectangle"
    ...
    temp = get_nested_attribute(action, '"Ellipse"', locals())
    if temp is None:
        temp = "Ellipse"
    ...
    if temp is None:
        temp = v39
    if action is not None and hasattr(action, "view4".split('[')[0].split('.')[0]):
        action.view4 = temp
    else:
        view4 = temp 
    if model is not None: 
    ...
    temp = get_nested_attribute(action, '"Text"', locals())
    if temp is None:
        temp = "Text"
    ...
    if temp is None:
        temp = v52
    if action is not None and hasattr(action, "view5".split('[')[0].split('.')[0]):
        action.view5 = temp
    else:
        view5 = temp 
    if model is not None: 
    ...
    temp = get_nested_attribute(action, '"Arc"', locals())
    if temp is None:
        temp = "Arc"
    ...
    if temp is None:
        temp = v65
    if action is not None and hasattr(action, "view6".split('[')[0].split('.')[0]):
        action.view6 = temp
    else:
        view6 = temp 
    if model is not None: 
    ...
    temp = get_nested_attribute(action, '"ArcChord"', locals())
    if temp is None:
        temp = "ArcChord"
    ...
    if temp is None:
        temp = v78
    if action is not None and hasattr(action, "view7".split('[')[0].split('.')[0]):
        action.view7 = temp
    else:
        view7 = temp 
    if model is not None: 
    ...
    temp = get_nested_attribute(action, '"PieSlice"', locals())
    if temp is None:
        temp = "PieSlice"
    ...
    if temp is None:
        temp = v91
    if action is not None and hasattr(action, "view8".split('[')[0].split('.')[0]):
        action.view8 = temp
    else:
        view8 = temp 
    if model is not None: 
    ...
    temp = get_nested_attribute(action, '"Dot"', locals())
    if temp is None:
        temp = "Dot"
    ...
    if temp is None:
        temp = v104
    if action is not None and hasattr(action, "view9".split('[')[0].split('.')[0]):
        action.view9 = temp
    else:
        view9 = temp 
    if model is not None: 
    ...
    class Ex1(Model):
        def __init__(self, root: Root = None, view: View = None, origin=(0,0)):
            ...
            if temp is None:
                temp = v119
            if action is not None and hasattr(action, "cellSize".split('[')[0].split('.')[0]):
            ...
            temp = get_nested_attribute(action, 'cellSize', locals())
            if temp is None:
                temp = cellSize
            ...
            if temp is None:
                temp = v124
            if action is not None and hasattr(action, "line".split('[')[0].split('.')[0]):
                action.line = temp
            else:
                line = temp 
            if model is not None: 
            ...
            if temp is None:
                temp = v148
            if action is not None and hasattr(action, "ell".split('[')[0].split('.')[0]):
                action.ell = temp
            else:
                ell = temp 
            if model is not None: 
            ...
            temp = get_nested_attribute(action, '"Bla bla ..."', locals())
            if temp is None:
                temp = "Bla bla ..."
            ...
            temp = get_nested_attribute(action, '"purple"', locals())
            if temp is None:
                temp = "purple"
            ...
            if temp is None:
                temp = v161
            if action is not None and hasattr(action, "text".split('[')[0].split('.')[0]):
                action.text = temp
            else:
                text = temp 
            if model is not None: 
            ...
            temp = get_nested_attribute(action, '"tomato"', locals())
            if temp is None:
                temp = "tomato"
            ...
            if temp is None:
                temp = v172
            if action is not None and hasattr(action, "arc".split('[')[0].split('.')[0]):
                action.arc = temp
            else:
                arc = temp 
            if model is not None: 
            ...
            temp = get_nested_attribute(action, '150', locals())
            if temp is None:
                temp = 150
            ...
            temp = get_nested_attribute(action, '"cyan"', locals())
            if temp is None:
                temp = "cyan"
            ...
            if temp is None:
                temp = v190
            if action is not None and hasattr(action, "arcC".split('[')[0].split('.')[0]):
                action.arcC = temp
            else:
                arcC = temp 
            if model is not None: 
            ...
            if temp is None:
                temp = v210
            if action is not None and hasattr(action, "pieS".split('[')[0].split('.')[0]):
                action.pieS = temp
            else:
                pieS = temp 
            if model is not None: 
            ...
            if temp is None:
                temp = v229
            if action is not None and hasattr(action, "dot".split('[')[0].split('.')[0]):
                action.dot = temp
            else:
                dot = temp 
            if model is not None: 
    ...
    if temp is None:
        temp = v234
    if action is not None and hasattr(action, "ex1".split('[')[0].split('.')[0]):
        action.ex1 = temp
    else:
        ex1 = temp 
    if model is not None: 
    ...
    temp = get_nested_attribute(action, '0.5', locals())
    if temp is None:
        temp = 0.5
    ...
    for i in range(v236, v237, 1):
        ...
        temp = get_nested_attribute(action, 'ex1.line.origin', locals())
        if temp is None:
        ...
        temp = get_nested_attribute(action, 'ex1.rec.origin', locals())
        if temp is None:
            temp = ex1.rec.origin
        ...
        temp = get_nested_attribute(action, 'ex1.ell.origin', locals())
        if temp is None:
            temp = ex1.ell.origin
        ...
        temp = get_nested_attribute(action, 'ex1.text.origin', locals())
        if temp is None:
        ...
        temp = get_nested_attribute(action, 'ex1.arc.origin', locals())
        if temp is None:
            temp = ex1.arc.origin
        ...
        temp = get_nested_attribute(action, 'ex1.arcC.origin', locals())
        if temp is None:
        ...
        temp = get_nested_attribute(action, 'ex1.pieS.origin', locals())
        if temp is None:
        ...
        temp = get_nested_attribute(action, 'ex1.dot.origin', locals())
        if temp is None:
            temp = ex1.dot.origin
    ...
    temp = get_nested_attribute(action, 'v254', locals())
    if temp is None:
        temp = v254
    if action is not None and hasattr(action, "p".split('[')[0].split('.')[0]):
        action.p = temp
    ...
    print(v261)
    view4.close(); views.remove(view4) if last_view != view4 else None
    last_view = (views.pop(-1) if len(views) > 0 else None) if last_view == view4 else last_view
    root.last_view = last_view
    if action is not None:
        v262 = action.root.waitClick()
    else:
        v262 = root.waitClick()
    ...
    print(v264)
    view5.close(); views.remove(view5) if last_view != view5 else None
    last_view = (views.pop(-1) if len(views) > 0 else None) if last_view == view5 else last_view
    root.last_view = last_view
    if action is not None:
        v265 = action.root.waitClick()
    else:
        v265 = root.waitClick()
    ...
    print(v267)
    view6.close(); views.remove(view6) if last_view != view6 else None
    last_view = (views.pop(-1) if len(views) > 0 else None) if last_view == view6 else last_view
    root.last_view = last_view
    if action is not None:
        v268 = action.root.waitClick()
    else:
        v268 = root.waitClick()
    ...
    print(v270)
    view7.close(); views.remove(view7) if last_view != view7 else None
    last_view = (views.pop(-1) if len(views) > 0 else None) if last_view == view7 else last_view
    root.last_view = last_view
    if action is not None:
        v271 = action.root.waitClick()
    else:
        v271 = root.waitClick()
    ...
    print(v273)
    view8.close(); views.remove(view8) if last_view != view8 else None
    last_view = (views.pop(-1) if len(views) > 0 else None) if last_view == view8 else last_view
    root.last_view = last_view
    if action is not None:
        v274 = action.root.waitClick()
    else:
        v274 = root.waitClick()
    ...
    print(v276)
    view9.close(); views.remove(view9) if last_view != view9 else None
    last_view = (views.pop(-1) if len(views) > 0 else None) if last_view == view9 else last_view
    root.last_view = last_view
